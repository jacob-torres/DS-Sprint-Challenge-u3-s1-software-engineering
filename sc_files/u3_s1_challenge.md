...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  I believe it's very important to include positive feedback **as well** as constructive criticism.
  If at all possible, the positive feedback should go at the beginning and end of the review.
  This is to soften the blow of the criticism, and helps the two people involved maintain a good working relationship,
  even if the person whose code is being reviewed doesn't necessarily agree.
  Most times, a programmer only wants to show others their code when they feel relatively confident in the work they've done.
  Thus, it's vital not to forget that the code you're reviewing is someone else's baby. Procede with caution.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  Containers are designed to solve this exact problem.
  When a piece of software is being developed, it is running in a
  specific environment with specific dependencies. This is unavoidable. However,
  containers help programmers isolate their project code in a virtual environment,
  whose exact dependencies are documented and accounted for when the product is being developed.
  This way, people who want to use the project code in the future
  will know up front exact what environment is required, and how to recreate it on their own machine.
  The power of this idea is in the fact that multiple computers can run the same program,
  regardless of the software environment of any one of them.
